...
class spectralClustering:
    def __init__(self,inputFile,outputDirectory,k,connectvity,memory,nComponents,computeFUllTree):
        self.inputFile = inputFile
        self.outputDir = outputDirectory
        self.k = k
        self.connectivity = connectvity
        self.memory = memory
        self.nComponents = nComponents
        self.computeFullTree = computeFUllTree
    ...
    def run(self):
        ...
        if (self.inputFile == '' or self.outputDir == '' or self.k == '' or self.n_init==''):
            ...
            spectralClustering = wa(n_clusters=int(self.k),=self.eigenSolver,random_state=self.random_state,
